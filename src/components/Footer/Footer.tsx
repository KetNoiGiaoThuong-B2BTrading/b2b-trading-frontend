            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-[2fr_4fr] gap-10">
                    <div className="w-full max-w-xs">
                        <h2 className="text-xl font-bold">Đăng ký nhận thông tin</h2>
                        <p className="mt-4 text-sm text-gray-300">
                            Nhận thông tin mới nhất về sản phẩm, chương trình ưu đãi và cơ hội hợp tác kinh doanh.
                        </p>
                        <input
                            type="email"
                            placeholder="Nhập email của bạn"
                            className="mt-4 w-full px-4 py-2 text-sm rounded-lg text-black border bg-white"
                        />
                        <div className="mt-4">
                            <button
                                disabled={!accepted}
                            ...
                            <div className="flex items-start gap-2 mt-3 text-sm text-gray-300">
                                <input
                                    type="checkbox"
                                    id="accept"
                                    checked={accepted}
                                ...
                                <label htmlFor="accept">
                                    Tôi đồng ý với <a href="#" className="text-blue-400 underline">chính sách xử lý dữ liệu cá nhân</a>.
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div>
                            <h3 className="font-semibold text-base mb-3">Hướng dẫn</h3>
                            <ul className="text-sm text-gray-300 space-y-2">
                                <li><a href="#" className="hover:underline">Phương thức thanh toán</a></li>
                                <li><a href="#" className="hover:underline">Đặt hàng và nhận hàng</a></li>
                                <li><a href="#" className="hover:underline">Giao hàng</a></li>
                                <li><a href="#" className="hover:underline">Mua hàng qua điện thoại</a></li>
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-gray-300 space-y-2">
                                ...
                                <li><a href="#" className="hover:underline">Góp ý dịch vụ</a></li>
                            </ul>
                        </div>

                        <div>
                            <h3 className="font-semibold text-base mb-3">Dịch vụ</h3>
                            <ul className="text-sm text-gray-300 space-y-2">
                                <li><a href="#" className="hover:underline">Vận chuyển</a></li>
                                <li><a href="#" className="hover:underline">Bảo trì thiết bị</a></li>
                                <li><a href="#" className="hover:underline">Tư vấn giải pháp</a></li>
                                <li><a href="#" className="hover:underline">Thu gom & tái chế</a></li>
                                <li><a href="#" className="hover:underline">Lắp đặt & tháo dỡ</a></li>
                            </ul>
                        </div>

                        <div>
                            <h3 className="font-semibold text-base mb-3">Về chúng tôi</h3>
                            <ul className="text-sm text-gray-300 space-y-2">
                ...
                <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
                    <div>© 2025 Kết Nối Giao Thương.</div>
